        ...
        <div className="flex items-center justify-between mb-6">
          ...
          {hasActiveFilters && (
            <button
              ...
              className="text-xs text-chai-brown-light hover:underline flex items-center gap-1"
            >
              <X size={14} />
              Clear all
            </button>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 rounded-lg border border-chai-brown/20 bg-cream text-chai-brown font-sans text-sm focus:outline-none focus:border-chai-brown-light transition-colors"
            >
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg border border-chai-brown/20 bg-cream text-chai-brown font-sans text-sm focus:outline-none focus:border-chai-brown-light transition-colors placeholder:text-chai-brown-light"
            />
          </div>
        </div>
      </div>
