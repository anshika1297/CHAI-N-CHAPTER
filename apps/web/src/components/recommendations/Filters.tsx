        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <select
              ...
              className="w-full px-4 py-2 rounded-lg border border-chai-brown/20 bg-cream text-chai-brown font-sans text-sm focus:outline-none focus:border-sage transition-colors"
            >
              <option value="newest">Newest First</option>
              <option value="oldest">Oldest First</option>
              <option value="reading-time">Reading Time (Longest)</option>
              <option value="book-count">Most Books</option>
            </select>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2 rounded-lg border border-chai-brown/20 bg-cream text-chai-brown font-sans text-sm focus:outline-none focus:border-sage-green transition-colors placeholder:text-chai-brown-light"
            />
          </div>
